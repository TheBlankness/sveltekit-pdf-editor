...
>
	...
	>
		<!-- <div
			...
			class="absolute left-0 top-0 w-2 h-2 bg-green-400 rounded-full
      cursor-nwse-resize transform -translate-x-1/2 -translate-y-1/2 md:scale-25"
		/>
		<div
			data-direction="right-bottom"
			class="absolute right-0 bottom-0 w-2 h-2 bg-green-400 rounded-full
      cursor-nwse-resize transform translate-x-1/2 translate-y-1/2 md:scale-25"
		/> -->
	</div>
	<!-- <div
		on:click={onDelete}
		class="absolute left-0 top-0 right-0 w-2 h-2 m-auto rounded-full bg-white
    cursor-pointer transform -translate-y-1/2 md:scale-25"
	>
		<img class="w-full h-full" src="/icons/delete.svg" alt="delete object" />
	</div> -->
