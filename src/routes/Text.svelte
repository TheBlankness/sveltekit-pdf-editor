      ...
      border-gray-400"
		>
			<div class="mr-2 flex items-center">
				<img src="/icons/line_height.svg" class="w-6 mr-2" alt="Line height" />
				<input
					type="number"
					min="1"
					max="10"
			...
			<div class="mr-2 flex items-center">
				<img src="/icons/text.svg" class="w-6 mr-2" alt="Font size" />
				<input
					type="number"
					min="12"
					max="120"
			...
			<div class="mr-2 flex items-center">
				<img src="/icons/text-family.svg" class="w-4 mr-2" alt="Font family" />
